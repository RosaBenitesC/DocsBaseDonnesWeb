...
--
	...
	SELECT dbo.ufn_NBArticlesDifferentPourUneCategorie(1) AS 'Nbre  d''articles différents vendus pour la categorie 1, Électroménagers'
	go
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
--
-- Q3 A) Création d'une fonction pour obtenir le nombre total d'articles vendus pour une catégorie donnée
	...
	SELECT dbo.ufn_NbTotalArticlesPourUneCategorie(1) AS 'Nbre total d''articles vendus pour la categorie 1, Électroménagers'
	go
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
--
