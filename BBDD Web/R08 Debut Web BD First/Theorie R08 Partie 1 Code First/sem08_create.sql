...
CREATE VIEW VW_DetailsSerie AS
...
CREATE PROCEDURE USP_ChercherSeriesParActeur
	@Prenom nvarchar(50),
	@Nom nvarchar(50)
AS
...
CREATE PROCEDURE USP_ProcedureSansRetour
AS
...
CREATE TRIGGER Series.TR_ActeurSerie_idActeurSerie
